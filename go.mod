module github.com/hertz-contrib/swagger-generate/protoc-gen-rpc-swagger
...
replace google.golang.org/genproto => google.golang.org/genproto v0.0.0-20240730163845-b1a4ccb954bf
